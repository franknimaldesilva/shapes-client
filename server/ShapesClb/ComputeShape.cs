...
namespace ShapesClb
{
  public class ComputeShape : IComputeShape
  {
    ...
    {
      // using reflections, which may be an overkill in this instant. I find it useful for building process pipe lines as it reduces code changes
      // required in this case if a new shape is added. If I had used a case statement here that would need to be updated
